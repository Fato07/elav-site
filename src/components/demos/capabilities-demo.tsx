...
const capabilities = [
  {
    ...
    description:
      "Unlike other AI tools, DenchClaw uses your existing Chrome profile — all your auth sessions, cookies, and history. It logs into LinkedIn, scrapes YC batches, and sends messages as you.",
    demo: (
      <div className="bg-stone-900 rounded-xl p-4 text-[11px] font-mono text-stone-300 space-y-1.5 shadow-inner">
        <p className="text-stone-500">{"// DenchClaw detects your active Chrome profile"}</p>
  ...
  },
  {
    ...
    description:
      "Ask questions in plain English — DenchClaw translates to SQL, queries your DuckDB, and returns structured results. Like having a data analyst on speed dial.",
    demo: (
  ...
  },
  {
    ...
    description:
      "DenchClaw doesn't just talk — it writes code. Review changes in a rich diff viewer before applying. Like Cursor, but for your whole system.",
    demo: (
  ...
  },
  {
    ...
    description:
      "DenchClaw has full access to your Mac — files, apps, documents. It remembers context across sessions, learns your preferences, and proactively handles tasks.",
    demo: (
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-stone-500 text-lg max-w-xl mx-auto">
            DenchClaw doesn&apos;t just answer questions. It takes action — browsing the web,
